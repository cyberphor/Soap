<#
    ...
    .DESCRIPTION
    Configures the local audit policy using recommendations from Microsoft, Malware Archaeology, the National Security Agency, or the DoD Windows 10 STIG.
...
Param(
    [parameter(Mandatory)][ValidateSet("Microsoft","Malware Archaeology","The NSA","The DoD Windows 10 STIG")]$Source
)
...
function Set-AuditPolicyUsingTheNsaRecommendations {

}

function Set-AuditPolicyUsingTheDoDWindows10Stig {
    auditpol /clear /y
...
if ($Prompt.ToLower() -eq "y") {
    switch ($Source) {
        ...
        "The National Security Agency" { Set-AuditPolicyUsingTheNsaRecommendations }
        "The DoD Windows 10 STIG" { Set-AuditPolicyUsingTheDoDWindows10Stig }
    }
}
